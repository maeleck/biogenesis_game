    ...
    <div className="bg-gray-800/80 backdrop-blur-sm rounded-xl p-3 md:p-4 shadow-lg border border-gray-700 flex flex-col h-full">
      <div className="flex-grow">
        ...
        <div className="space-y-2 text-[11px] md:text-xs">
          <div>
            <span className="text-[11px] md:text-xs font-semibold text-red-400 uppercase">Consumes /s</span>
          ...
          <div>
            <span className="text-[11px] md:text-xs font-semibold text-green-400 uppercase">Produces /s</span>
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-1 md:space-x-2">
          <button
            ...
            className="px-2 py-0.5 md:px-3 md:py-1 bg-red-600 hover:bg-red-700 rounded-md disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors font-bold"
          ...
          <button
            ...
            className="px-2 py-0.5 md:px-3 md:py-1 bg-green-600 hover:bg-green-700 rounded-md disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors font-bold"
