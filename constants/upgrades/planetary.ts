   ...
   // --- PLANETARY ERA (Middle Tier) ---
  {
    ...
    panelContent: {
      facts: [
        ...
        {
          text: "Planetary migration is a process where a planet interacts with the gas disk it formed in, causing its orbit to move inwards or outwards. This explains how 'Hot Jupiters' can exist so close to their stars.",
          quiz: {
            question: "What process explains the existence of 'Hot Jupiters' very close to their stars?",
            options: ["Stellar Flares", "Planetary Migration", "Gravitational Lensing", "Asteroid Impacts"],
            answerIndex: 1
          }
        }
      ],
  ...
  },
  {
    ...
    panelContent: {
        facts: [
            ...
            {
              text: "The Oort Cloud is a theoretical spherical cloud of icy planetesimals surrounding the Sun at vast distances. It is believed to be the origin of long-period comets.",
              quiz: {
                question: "What is believed to be the origin of long-period comets?",
                options: ["The Asteroid Belt", "The Kuiper Belt", "The Oort Cloud", "The Sun's Corona"],
                answerIndex: 2
              }
            }
        ],
  ...
  },
  {
    ...
    panelContent: {
      facts: [
        ...
        {
          text: "Planetesimals, the building blocks of planets, are thought to have started as kilometer-sized objects. It remains a challenge for models to explain how they grew so large from tiny dust grains.",
          quiz: {
            question: "What was the approximate initial size of planetesimals, the building blocks of planets?",
            options: ["Meter-sized", "Kilometer-sized", "Moon-sized", "Continent-sized"],
            answerIndex: 1
          }
        }
      ],
  ...
  },
   {
    ...
    panelContent: {
        facts: [
            ...
            {
              text: "Scientists study the interior of the Earth by analyzing seismic waves (P-waves and S-waves) generated by earthquakes. The way these waves travel and reflect reveals the boundaries between the crust, mantle, and core.",
              quiz: {
                question: "How do scientists primarily study the Earth's internal layers?",
                options: ["By drilling to the core", "By analyzing seismic waves from earthquakes", "By studying volcanic lava", "By measuring the magnetic field"],
                answerIndex: 1
              }
            }
        ],
  ...
  },
  {
    ...
    panelContent: {
        facts: [
            ...
            {
              text: "Tidal locking is when an orbiting astronomical body always has the same face toward the body it is orbiting. This is why we always see the same side of the Moon from Earth.",
              quiz: {
                question: "Why do we always see the same side of the Moon?",
                options: ["The Moon does not rotate", "Due to Earth's magnetic field", "Due to tidal locking", "It is an optical illusion"],
                answerIndex: 2
              }
            }
        ],
  ...
  },
  {
    ...
    panelContent: {
      facts: [
        ...
        {
          text: "A comet's nucleus is often called a 'dirty snowball.' It's a solid, core structure composed of rock, dust, water ice, and frozen gases such as carbon dioxide, carbon monoxide, methane, and ammonia.",
          quiz: {
            question: "What is the nucleus of a comet often referred to as?",
            options: ["A rocky asteroid", "A dusty planetoid", "A dirty snowball", "A molten core"],
            answerIndex: 2
          }
        }
      ],
  ...
  },
   {
    ...
    panelContent: {
        facts: [
            ...
            {
              text: "The deepest part of Earth's oceans is the Mariana Trench, reaching a depth of nearly 11,000 meters (36,000 feet). The pressure there is over 1,000 times that at the surface.",
              quiz: {
                question: "What is the deepest part of Earth's oceans called?",
                options: ["The Mid-Atlantic Ridge", "The Bermuda Triangle", "The Mariana Trench", "The Great Barrier Reef"],
                answerIndex: 2
              }
            }
        ],
  ...
  },
  {
    ...
    panelContent: {
      facts: [
        ...
        {
          text: "A supervolcano is a volcano capable of producing an eruption with ejecta greater than 1,000 cubic kilometers. Such an event could cause a volcanic winter and have catastrophic effects on global climate.",
          quiz: {
            question: "What is the defining characteristic of a supervolcano eruption?",
            options: ["It produces very hot lava", "It has ejecta greater than 1,000 cubic kilometers", "It only occurs underwater", "It creates new islands"],
            answerIndex: 1
          }
        }
      ],
  ...
  },
  {
    ...
    panelContent: {
        facts: [
            ...
            {
              text: "Mid-ocean ridges are underwater mountain ranges where new oceanic crust is formed through volcanic activity. This process of seafloor spreading is a key part of plate tectonics.",
              quiz: {
                question: "Where is new oceanic crust formed?",
                options: ["In subduction zones", "At mid-ocean ridges", "On continental shelves", "At the bottom of trenches"],
                answerIndex: 1
              }
            }
        ],
  ...
  },
  {
    ...
    panelContent: {
        facts: [
            ...
            {
              text: "The Van Allen radiation belts are zones of energetic charged particles, held in place by a planet's magnetic field. They protect the planet from harmful solar wind but can be hazardous to satellites and astronauts.",
              quiz: {
                question: "What are the zones of energetic particles held in place by a planet's magnetic field called?",
                options: ["The ionosphere", "The Van Allen radiation belts", "The aurora borealis", "The exosphere"],
                answerIndex: 1
              }
            }
        ],
